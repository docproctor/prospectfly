...
const criteria = [
  {
    ...
    title: "Your market",
    description:
      "Is there real search or social demand for what you sell? If nobody is searching for it and nobody fits your target audience profile, ads won't fix that.",
  },
  {
    num: 2,
    title: "Your economics",
    description:
      "What's a customer worth to you? What can you afford to pay to acquire one? If the numbers don't work on paper, they won't work in the account either.",
  },
  {
    num: 3,
    title: "Your conversion path",
    description:
      "Where does the traffic go? A strong campaign sending people to a weak landing page is wasted budget. We look at the full funnel, not just the ads.",
  },
  {
    num: 4,
    title: "Your budget",
    description:
      "Google Ads and Meta both need a minimum spend to generate enough data to optimise. We'll tell you what that minimum looks like for your specific market.",
  },
  {
    num: 5,
    title: "Your expectations",
    description:
      "Paid ads are not instant. Most accounts take 60-90 days to find their stride. If you need 10 customers tomorrow, this isn't the right conversation.",
  },
];
  ...
  return (
    <main className="bg-[#0a0a0a] text-white min-h-screen">
      ...
      <section className="pt-24 pb-6 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-gray-400 text-lg leading-relaxed">
            That means an honest conversation before anything else. If your
            budget, market or business model isn't right for paid ads, we'll
            tell you.
          </p>
        </div>
      </section>
      ...
      <section className="pt-6 pb-16 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="bg-[#16191f] rounded-2xl p-10 border border-white/5">
            <p className="text-xl md:text-2xl text-white font-medium leading-relaxed text-center">
              "Most campaigns that fail do so before they launch. Wrong channel.
              Wrong budget. Wrong expectations. We fix that in the first call."
            </p>
          </div>
        </div>
      </section>
